...
public class ControllerAdvisor {
    ...
    public ResponseEntity<Map<String, String>> handleUserUnderageException(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(Collections.singletonMap(RESPONSE_ERROR_MESSAGE_KEY, USER_NO_CREATED_UNDERAGE_MESSAGE));
    }

    @ExceptionHandler(UserNotCreatedException.class)
    public ResponseEntity<Map<String, String>> handleUserNotCreatedException(
            UserNotCreatedException userNotCreatedException) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(Collections.singletonMap(RESPONSE_ERROR_MESSAGE_KEY, USER_NO_CREATED_MESSAGE));
    }
